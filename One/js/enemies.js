import {damagePlayer, lerpAngle, checkCollision, toPlayer, delta, canvasDimesions, enemies } from "./main.js";
...
export class BlueBlock extends Enemy {
    ...
    draw(context) {
        ...
        drawCenteredRect(this.x, this.y, this.width, this.height);
    }
...
function getValidSpawnPoint() {
    ...
    let halfBiggerDimension = Math.max(canvasDimesions.height, canvasDimesions.width) / 2;
